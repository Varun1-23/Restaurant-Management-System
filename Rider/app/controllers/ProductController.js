    ...
    .controller("ProductController", ["app.config", "$scope", "LoginService", "AuthenticationService", "$state", "$stateParams", "MainService", "localStorageService",
        function (config, $scope, LoginService, AuthenticationService, $state, $stateParams, MainService, localStorageService) {
            ...
            $scope.init = function () {
                ...
                $scope.Products = [];
                MainService.GetProductsByRestaurant($scope.TokenInfo.RestaurantId).then(function (response) {
                    if (response.data) {
            ...
            // $scope.Products = [];
            // MainService.GetProductsByRestaurant($scope.addData.RestaurantId).then(function (response) {
            //     if (response.data) {
            //         $scope.Products = response.data;
            //     } else {
            //         toastr.error("Failed");
