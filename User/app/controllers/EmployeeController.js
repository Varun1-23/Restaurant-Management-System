    ...
    .controller("EmployeeController", ["app.config", "$scope", "LoginService", "AuthenticationService", "$state", "$stateParams", "MainService", "localStorageService",
        function (config, $scope, LoginService, AuthenticationService, $state, $stateParams, MainService, localStorageService) {
            ...
            $scope.init = function () {
                ...
                $scope.Employees = [];
                MainService.GetEmployees().then(function (response) {
                    if (response.data) {
            ...
            $scope.saveData = function () {
                if ($scope.addData.Name == "") {
                    ...
                    MainService.SaveEmployee($scope.addData).then(function (response) {
                        if (response.data) {
            ...
            $scope.deleteData = function (data) {
                MainService.DeleteEmployee(data.Id).then(function (response) {
                    if (response.data) {
                        toastr.success("Success");
                        $scope.init();
                    } else {
